...
<div>
			  ...
			  <td>
				<%-- 	
				 <c:if test="${ dto.writer == '이창익' }">
             		<img src="/jspPro/days09/replyboard/images/star.png">
         		 </c:if>
				--%>
				<img src="/jspPro/days09/replyboard/emoticon/${dto.writer}.png">
	...
	<form>
      <tr>
		...
		<input type="button" style="height: 22px; width: 50px" value="검색"	id="searchBtn"></td>
	  </tr>
	</form>
	</table>
